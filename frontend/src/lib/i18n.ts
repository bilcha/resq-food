  ...
  uk: {
    common: {
      ...
      common: {
        ...
        explore_listings: "Дослідити оголошення",
      ...
      home: {
        title: "ResQ Food - Зменшуємо харчові відходи",
        meta_description: "Зв'язуйтеся з бізнесами, щоб отримати надлишки їжі за знижкою та допомогти зменшити харчові відходи.",
        hero_title: "Рятуйте їжу, рятуйте планету",
        hero_subtitle: "Зв'язуйтеся з місцевими підприємствами, щоб отримати надлишки їжі за знижкою та допомогти зменшити харчові відходи.",
        features_subtitle: "Прості кроки для зменшення харчових відходів та економії грошей",
        step1_title: "Підприємства розміщують",
        step1_description: "Місцеві підприємства розміщують свої надлишки їжі за знижкою",
        step2_title: "Переглядайте та бронюйте",
        step2_description: "Знаходьте найближчі оголошення та бронюйте ваші сюрпризні пакети з їжею",
        step3_title: "Забирайте та насолоджуйтеся",
        step3_description: "Забирайте свою їжу та насолоджуйтеся, допомагаючи навколишньому середовищу",
        cta_subtitle: "Приєднуйтеся до тисяч людей та підприємств, які разом борються з харчовими відходами."
      },
      about: {
        title: "Про нас - ResQ Food",
        meta_description: "Дізнайтеся про місію ResQ Food зі зменшення харчових відходів та з'єднання підприємств зі споживачами.",
        page_title: "Про ResQ Food",
        page_subtitle: "Наша місія зі зменшення харчових відходів та допомоги навколишньому середовищу",
        intro: "ResQ Food — це соціально-екологічна платформа, яка з'єднує підприємства з надлишками їжі зі споживачами, які шукають доступні, якісні страви. Ми надихаємося успішними глобальними ініціативами, такими як Too Good To Go та OLIO, але адаптованими спеціально для українського ринку.",
        mission_title: "Наша місія",
        mission_description: "Щороку мільйони тонн їжі йдуть у відходи, в той час як багато людей борються з продовольчою невпевненістю. Ми віримо, що технології можуть подолати цю прірву, зробивши надлишки їжі доступними для всіх, водночас допомагаючи підприємствам зменшити відходи та відшкодувати витрати.",
      ...
      contact: {
        ...
        faq_a1: "Підприємства розміщують свої надлишки їжі за знижкою, а споживачі можуть переглядати та купувати ці товари, щоб зменшити відходи.",
        ...
        faq_q3: "Як підприємства можуть приєднатися?",
        faq_a3: "Підприємства можуть зареєструватися на нашій платформі та почати розміщувати свої надлишки їжі відразу після затвердження."
      },
      admin: {
      ...
      footer: {
        description: "Зменшуємо харчові відходи, з'єднуючи підприємства з надлишками їжі зі споживачами.",
        copyright: "© 2025 ResQ Food. Всі права захищені."
      },
      listings: {
        title: "Оголошення про їжу - ResQ Food",
        meta_description: "Переглядайте доступні оголошення про їжу від місцевих підприємств за знижкою.",
        page_title: "Доступні оголошення про їжу",
        page_subtitle: "Відкрийте для себе надлишки їжі від місцевих підприємств за знижкою та допоможіть зменшити харчові відходи",
        view_label: "Вигляд:",
        grid_view: "Сітка",
        map_view: "Карта",
      ...
      login: {
        ...
        page_title: "Увійти до свого акаунту",
      ...
      register: {
        ...
        meta_description: "Зареєструйте свій бізнес в ResQ Food, щоб почати розміщувати надлишки їжі.",
        page_title: "Зареєструйте свій бізнес",
        page_subtitle: "Приєднайтеся до боротьби з харчовими відходами",
        email_label: "Електронна адреса",
        password_label: "Пароль",
        ...
        description_placeholder: "Розкажіть про свій бізнес та типи їжі, які ви пропонуєте...",
      ...
      listing_detail: {
        back_to_listings: "Назад до оголошень",
        ...
        get_directions: "Отримати маршрут",
        contact_business: "Зв'язатися з бізнесом",
        note_label: "Примітка:",
        note_message: "Будь ласка, зв'яжіться з бізнесом, щоб підтвердити наявність та домовитися про час забору перед відвідуванням.",
      ...
      components: {
        ui: {
          offline_data_status: {
            title: "Статус автономних даних",
            refresh_data: "Оновити дані",
            sync_now: "Синхронізувати зараз",
            retry_images: "Повторити зображення",
            loading: "Завантаження...",
            syncing: "Синхронізація...",
            local_storage: "Локальне сховище",
            businesses: "Бізнеси",
            listings: "Оголошення",
            pending_changes: "Зміни в очікуванні",
            images: "Зображення",
            ...
            no_offline_data_online: "Автономні дані недоступні. Натисніть «Оновити дані», щоб завантажити для автономного використання.",
            no_offline_data_offline: "Автономні дані недоступні. Підключіться до Інтернету, щоб завантажити дані для автономного використання."
          },
        ...
        business: {
          profile_form: {
            ...
            use_map_instead: "Використовувати карту замість цього",
        ...
        listings: {
          management: {
            ...
            subtitle: "Створюйте та керуйте оголошеннями про їжу для {{businessName}}",
          ...
          form: {
            ...
            offline_mode: "Офлайн режим: Зображення будуть завантажені після відновлення з'єднання",
            placeholders: {
              title: "Наприклад: Свіжі круасани",
              description: "Опишіть їжу, стан та будь-які особливі інструкції...",
              price: "0.00"
            },
            validation: {
          ...
          map: {
            load_error: "Не вдалося завантажити карту",
            unable_to_load: "Неможливо завантажити карту",
