...
const resources = {
  uk: {
    common: {
      ...
      home: {
        title:
          'ResQ Food — Разом проти марнування продуктів та забруднення планети',
        meta_description:
          'Отримуйте смачну їжу зі знижкою від місцевих бізнесів та долучайтеся до боротьби з марнуванням їжі.',
        hero_title: 'Не марнуй їжу — рятуй планету',
        hero_subtitle:
          'Отримуй смачну їжу за вигідною ціною та підтримуй локальні бізнеси.',
        features_subtitle: 'Як легко зменшити харчові відходи та заощадити',
        step1_title: 'Заклади публікують',
        step1_description:
          'Місцеві заклади пропонують свої харчові надлишки за вигідними цінами.',
        step2_title: 'Шукай і бронюй',
        step2_description:
          'Знаходь доступні пропозиції поблизу та бронюй свій пакунок-сюрприз',
        step3_title: 'Забирай і насолоджуйся',
        step3_description:
          'Забирай замовлення та насолоджуйся, знаючи, що робиш добру справу',
        cta_subtitle:
          'Долучайся до тисяч користувачів та бізнесів, які вже змінюють світ — разом проти марнування харчових продуктів!',
      },
      about: {
        title: 'Про нас - ResQ Food',
        meta_description:
          'ResQ Food — проєкт, що об’єднує бізнес і споживачів задля зменшення харчових відходів. Дізнайтеся більше!',
        page_title: 'Про ResQ Food',
        page_subtitle:
          'Наша місія зі зменшення харчових відходів та допомоги навколишньому середовищу',
        intro:
          "ResQ Food — це соціально-екологічна платформа, яка з'єднує заклади з надлишками їжі зі споживачами, які шукають доступні, якісні страви. Ми надихаємося успішними глобальними ініціативами, такими як Too Good To Go та OLIO, але адаптованими спеціально для українського ринку.",
        mission_title: 'Наша місія',
        mission_description:
          'Щороку мільйони тонн їжі йдуть у відходи, в той час як багато людей стикаються з нестачею продуктів. Ми віримо, що технології можуть допомогти подолати цю проблему, зробивши надлишки їжі доступнішими для всіх, водночас допомагаючи місцевим бізнесам зменшити витрати роблячи внесок у навколишнє середовище.',
        help_title: 'Як ми допомагаємо',
      },
      contact: {
        title: 'Контакти - ResQ Food',
        meta_description:
          "Зв'яжіться з командою ResQ Food. Ми тут, щоб допомогти з будь-якими питаннями про нашу платформу.",
        page_title: "Зв'яжіться з нами",
        page_subtitle:
          "Ми б хотіли почути від вас. Зв'яжіться з нашою командою.",
        ...
        faq_a1:
          'Заклади розміщують оголошення про надлишки продукції за знижкою, а споживачі можуть знаходити та купувати цю продукцію, щоб економити зменшуючи відходи.',
        faq_q2: 'Чи безпечно їсти надлишки їжі?',
        faq_a2:
          'Так! Вся їжа, розміщена на нашій платформі, безпечна для споживання та відповідає стандартам якості. Це просто надлишки, які інакше пішли б у відходи.',
        faq_q3: 'Як заклади можуть приєднатися?',
        faq_a3:
          'Заклади можуть зареєструватися на нашій платформі та почати розміщувати свої оголошення про надлишки продукції одразу після підтвердження реєстрації.',
      },
      admin: {
        title: 'Адміністративна панель - ResQ Food',
        page_title: 'Адміністративна панель',
        coming_soon:
          "Адміністративні елементи керування та аналітика скоро з'являться.",
      },
      business_dashboard: {
      ...
      footer: {
        description:
          "Зменшуємо марнування харчових продуктів, з'єднуючи заклади з надлишками продукції зі споживачами.",
        copyright: '© 2025 ResQ Food. Всі права захищені.',
      },
      listings: {
        title: 'Оголошення - ResQ Food',
        meta_description:
          'Переглядайте доступні оголошення від місцевих закладів за знижкою.',
        page_title: 'Доступні оголошення',
        page_subtitle:
          'Знайдіть пропозиції про розпродаж надлишків від місцевих закладів та допоможіть зменшити харчові відходи',
        view_label: 'Вигляд:',
        grid_view: 'Таблиця',
        map_view: 'Мапа',
        ...
        no_listings_message:
          'Наразі немає доступних оголошень, що відповідають вашим фільтрам.',
      ...
      login: {
        ...
        errors: {
          ...
          user_not_found:
            'Обліковий запис з цією електронною адресою не знайдено. Перевірте адресу або зареєструйте новий акаунт.',
          wrong_password: 'Неправильний пароль. Спробуйте ще раз.',
          invalid_email: 'Неправильна електронна адреса.',
          user_disabled:
            'Цей обліковий запис було заблоковано. Зверніться до підтримки.',
          too_many_requests:
      ...
      register: {
        ...
        meta_description:
          'Зареєструйте свій бізнес в ResQ Food, щоб почати розміщувати оголошення про надлишки продуктів.',
        page_title: 'Зареєструйте свій бізнес',
        page_subtitle:
          'Приєднайтеся до боротьби з марнуванням харчових продуктів',
        email_label: 'Електронна адреса',
        password_label: 'Пароль',
        ...
        description_placeholder:
          'Розкажіть про свій бізнес та типи продуктів, які ви пропонуєте...',
        ...
        validation: {
          ...
          business_name_min_length:
            'Назва бізнесу має містити принаймні 2 символи',
        ...
        errors: {
          ...
          email_in_use:
            'Ця електронна адреса вже зареєстрована. Використайте іншу адресу або спробуйте увійти.',
          weak_password:
            'Пароль занадто слабкий. Оберіть більш надійний пароль.',
          invalid_email: 'Неправильна електронна адреса.',
        },
      },
      listing_detail: {
        ...
        contact_business_message:
          "Зв'яжіться з бізнесом безпосередньо, щоб зарезервувати цей товар.",
        get_directions: 'Прокласти маршрут',
        contact_business: "Зв'язатися з бізнесом",
        note_label: 'Примітка:',
        note_message:
          "Будь ласка, зв'яжіться з бізнесом, щоб підтвердити наявність та домовитися про час візиту перед відвідуванням.",
      ...
      components: {
        ui: {
          offline_data_status: {
            ...
            no_offline_data_online:
              'Offline дані недоступні. Натисніть «Оновити дані», щоб завантажити для offline використання.',
            no_offline_data_offline:
              'Offline дані недоступні. Підключіться до Інтернету, щоб завантажити дані для offline використання.',
          },
        ...
        business: {
          profile_form: {
            ...
            email_readonly:
              'Електронну адресу неможливо змінити, оскільки це ідентифікатор вашого облікового запису.',
            ...
            enter_complete_address:
              'Введіть повну адресу вашого бізнесу вручну.',
            loading_map: 'Завантаження мапи...',
            selected_location: 'Вибране місцезнаходження:',
            business_description: 'Опис бізнесу',
            describe_business:
              'Опишіть ваш бізнес, особливості та те, що робить вас унікальними.',
            ...
            error_message:
              'Не вдалося оновити профіль бізнесу. Спробуйте ще раз.',
            search_or_click_map:
              'Введіть свою адресу або виберіть локацію на мапі',
            placeholders: {
        ...
        listings: {
          management: {
            ...
            subtitle:
              'Створюйте та керуйте оголошеннями про надлишки продуктів для {{businessName}}',
            ...
            create_first:
              'Створіть своє перше оголошення, щоб почати продавати надлишки їжі.',
            loading: 'Завантаження оголошень...',
            error_loading: 'Помилка завантаження оголошень',
          ...
          form: {
            ...
            image_info:
              'Максимальний розмір файлу: 5МБ. Підтримувані формати: JPG, PNG, WebP',
            offline_mode:
              "Offline режим: Зображення будуть завантажені після відновлення з'єднання",
            placeholders: {
              title: 'Наприклад: Свіжі круасани',
              description:
                'Опишіть їжу, стан та будь-які додаткові інструкції...',
              price: '0.00 ₴',
            },
            validation: {
  ...
  en: {
    common: {
      ...
      home: {
        ...
        meta_description:
          'Connect with businesses to get surplus food at discounted prices while helping reduce food waste.',
      ...
      about: {
        ...
        meta_description:
          "Learn about ResQ Food's mission to reduce food waste and connect businesses with consumers.",
        page_title: 'About ResQ Food',
        page_subtitle:
          'Our mission to reduce food waste and help the environment',
        intro:
          "ResQ Food is a social-ecological platform that connects businesses with surplus food to consumers looking for affordable, quality meals. We're inspired by successful global initiatives like Too Good To Go and OLIO, but tailored specifically for the Ukrainian market.",
        mission_title: 'Our Mission',
        mission_description:
          'Every year, millions of tons of food are wasted while many people struggle with food insecurity. We believe technology can bridge this gap by making surplus food accessible to everyone while helping businesses reduce waste and recover costs.',
        help_title: 'How We Help',
      },
      contact: {
        title: 'Contact - ResQ Food',
        meta_description:
          "Get in touch with the ResQ Food team. We're here to help with any questions about our platform.",
        ...
        faq_a1:
          'Businesses list their surplus food at discounted prices, and consumers can browse and purchase these items to reduce waste.',
        faq_q2: 'Is it safe to eat surplus food?',
        faq_a2:
          "Yes! All food listed on our platform is safe to eat and meets quality standards. It's simply surplus that would otherwise go to waste.",
        faq_q3: 'How can businesses join?',
        faq_a3:
          'Businesses can register on our platform and start listing their surplus food immediately after approval.',
      },
      admin: {
      ...
      listings: {
        ...
        meta_description:
          'Browse available food listings from local businesses at discounted prices.',
        ...
        no_listings_message:
          'There are currently no available listings matching your filters.',
      ...
      register: {
        ...
        meta_description:
          'Register your business with ResQ Food to start listing surplus food.',
        ...
        description_placeholder:
          'Tell us about your business and the types of food you offer...',
      ...
      listing_detail: {
        ...
        note_label: 'Note:',
        note_message:
          'Please contact the business to confirm availability and arrange pickup times before visiting.',
      ...
      components: {
        ...
        listings: {
          management: {
            ...
            subtitle:
              'Create and manage your food listings for {{businessName}}',
          ...
          form: {
            ...
            placeholders: {
              ...
              description:
                'Describe the food, condition, and any special instructions...',
              price: '0.00 ₴',
            },
            validation: {
