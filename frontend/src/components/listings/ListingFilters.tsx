          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
              <label className="label">
                {t('components.listings.filters.category')}
              </label>
              <select
                className="input"
              ...
              >
                <option value="">
                  {t('components.listings.filters.category_all')}
                </option>
            ...
            <div>
              <label className="label">
                {t('components.listings.filters.min_price')} ({CURRENCY.CODE})
              </label>
              <input
                type="number"
                min="0"
            ...
            <div>
              <label className="label">
                {t('components.listings.filters.max_price')} ({CURRENCY.CODE})
              </label>
              <input
                type="number"
                min="0"
            ...
            <div>
              <label className="label">
                {t('components.listings.filters.type')}
              </label>
              <select
                className="input"
                value={
                  localFilters.is_free === undefined
                    ? ''
                    : String(localFilters.is_free)
                }
                onChange={(e) =>
                  handleFilterChange(
                    'is_free',
              ...
              >
                <option value="">
                  {t('components.listings.filters.price_all')}
                </option>
                <option value="true">
                  {t('components.listings.filters.price_free')}
                </option>
                <option value="false">
                  {t('components.listings.filters.price_paid')}
                </option>
              </select>
            </div>
          </div>
          ...
          <div className="mt-4">
            <label className="flex items-center space-x-2 cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  handleFilterChange('hide_expired', e.target.checked)
                }
              />
