          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">
                    {t('contact.business_partnerships')}
                  </h3>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600">{t('contact.faq_a1')}</p>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900">
                    {t('contact.faq_q2')}
                  </h3>
                  <p className="text-gray-600">{t('contact.faq_a2')}</p>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900">
                    {t('contact.faq_q3')}
                  </h3>
                  <p className="text-gray-600">{t('contact.faq_a3')}</p>
                </div>
              </div>
            </div>
          </div>
